...
export class ContaPremium extends Conta {
    registrarTransacao(transacao) {
        ...
        // Ao inves de utilizarmos "this", iremos utilizar "super" para utilizar a função da class pai do nosso objeto
        // this.registrarTransacao(transacao);
        super.registrarTransacao(transacao);
    }
}
const conta = new Conta("Joana da Silva Olveira");
const contaPremium = new ContaPremium("Mônica Hilton");
